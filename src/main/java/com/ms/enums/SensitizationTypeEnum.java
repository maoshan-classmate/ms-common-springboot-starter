...
public enum SensitizationTypeEnum {
    ...
    CUSTOM {
        ...
        public String sensitizeDate(String content, int startInclude, int endExclude, String customChar, JsonGenerator jsonGenerator) throws IOException {
            String customHidden = CharSequenceUtil.hide(String.valueOf(content), startInclude,
    ...
    public abstract String sensitizeDate(String content, int startInclude, int endExclude, String customChar, JsonGenerator jsonGenerator) throws IOException;
